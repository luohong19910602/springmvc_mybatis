...
public interface ArticleTypeMapper {  
	...
	@Select(value = "select * from sys_article_type where article_del_flag=0")  
	@Results(value = { 
			@Result(id = true, property = "id", column = "id"),  
			@Result(property = "name", column = "article_title"),
			@Result(property = "desc", column = "article_content"),
			...
			@Result(property = "delFlag", column = "article_del_flag")
	})  
