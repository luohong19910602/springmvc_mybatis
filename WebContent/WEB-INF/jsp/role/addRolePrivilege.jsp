...
<script type="text/javascript">
	...
	var menuId = data["menuId"];  //取得menu id
	var grid = data["grid"];  //获得list界面的grid对象，关闭dialog时，刷新数据
    
	//设置menuId到表单中
	$(function() {
		//实例化权限数据
		$("#privilegeIds").ligerComboBox({
            resize: true,
            width: 400,
            height: 30,
            selectBoxWidth: 400,
            valueFieldID: "privilegeIdList",  //隐藏id字段
            valueField: "id",  //
            textField: 'text', treeLeafOnly: true,
            tree: { url: '${baseURL}/privilege/listTreeJson.do', ajaxType: 'get'}
		});
		...
		$("#Button1").click(function(){
			...
			$.ajax({
                cache: true,
                type: "POST",
                url:"${baseURL }/role/addRolePrivilegeSubmit.do",
...
<body>
	<form id="form1" name="form1" method="post"
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
				<td align="right" class="l-table-edit-td">资源列表:</td>
				<td align="left" class="l-table-edit-td">
				<input name="privilegeIds" id="privilegeIds"></td>
				<td align="left"></td>
			</tr>
