	...
	$(function() {
		$("#Button1").click(function(){
			...
			$.ajax({
                cache: true,
                type: "POST",
                url:"${baseURL }/privilege/editSubmit.do",
	...
	<form id="form1" name="form1" method="post"
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
				...
				<input name="id" value="${privilege.id }" type="hidden">
				
				<input name="name"
					type="text" id="name" value="${privilege.name }" ltype="text" />
				
				<input type="hidden"
					id="parentId" name="parentId" value="${privilege.parentId }"></td>
				<td align="left"></td>
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td">
				<input name="url"
					type="text" id="url" ltype="text" value="${privilege.url }" style="display:inline-block; width:400px"/></td>
				<td align="left"></td>
			</tr>
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td">
				<textarea cols="100" rows="4" value="${privilege.desc }" class="l-textarea" id="desc" name="desc" style="width:400px" validate="{required:true}" ></textarea>
				</td>
				<td align="left"></td>
			</tr>
		</table>
