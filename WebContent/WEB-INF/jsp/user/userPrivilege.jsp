	...
	$(function() {
				...
				.ligerGrid(
						{
							...
							dataAction : "server",
							url : "${baseURL}/user/getUserPrivilegeJson.do?userId=${userId}",
							height : "400",
							pageSize : 30,
							width : "98%",
							tree : {
		...
		function addPrivilege() {
			...
			$.ligerDialog.open({
				...
				width : 600,
				title : '添加角色权限',
				url : "${baseURL}/user/addUserPrivilege.do?userId=${userId}",
				showMax : false,
				showToggle : true,
				showMin : false,
				isResize : true,
		...
		function deletePrivilege() {
			...
			var url = "${baseURL}/user/deleteUserPrivilege.do?privilegeIdStr=" + privilegeIdStr
					+ "&userId=${userId}";
			$.ajax({
				type : "POST",
				url : url,
